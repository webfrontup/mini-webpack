<template>
    <div class="order-cent">
        ...
        <div v-if="list.length != 0" class="order-list">
            ...
            <ul>
                <li class="pk-1px-t" @click="toggle(chessLists)" v-for="chessLists in list" :key="chessLists.id">
                    <div class="top clearfix">
                        <div class="text-dots left">{{chessLists.gameTranslatedName}}</div>
                        <div class="text-dots right winlose">{{chessLists.gameResult?chessLists.gameResult:'未结算' }}</div>
