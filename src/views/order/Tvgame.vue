<template>
    <div class="order-cent">
        ...
        <div v-if="list.length != 0" class="order-list">
            ...
            <ul>
                <li class="pk-1px-t" @click="toggle(tvgames)" v-for="tvgames in list" :key="tvgames.id">
                    <div class="top clearfix">
                        <div class="text-dots left">{{tvgames.gameTranslatedName}}</div>
                        <div class="text-dots right winlose">{{tvgames.gameResult?tvgames.gameResult:'未结算'}}</div>
