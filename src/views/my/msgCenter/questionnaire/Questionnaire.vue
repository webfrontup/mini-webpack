                ...
                <div class="view-content-width">
                    <ul class="view-content-width-ul">
                        ...
                        <li v-for="(question,index) in questionView.questionViewList " class="question-item" :key="index">
                            <label class="question-index" :class="{'must':question.must}"></label>
                                ...
                                <div class="question-answer">
                                    ...
                                    <ul v-show="question.type == 4 ">
                                        <li class="pk-star-parent">
                                            <star-rating :star-size="starSize" @rating-selected="setRating($event, question,index)" :max-rating="question.starType  == 1?5:10" :rating="question.userAnswer *1"></star-rating>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        methods: {
            ...
            sub() {
                ...
                this.questionView.questionViewList.map(function(v) {
                    console.log( v.userAnswerOther );
                    var qs = {
                        titleId: v.titleId,
                        type: v.type == 4 ? (v.starType == 1 ? 4 : 5) : v.type,
                        userAnswer: v.type == 1 && v.userAnswerOther == 1 ? "" : v.userAnswer,
