<template>
    <div class="my" ref="my">
        <div class="topmy">
            <nut-navbar class="info-header" @on-click-back="more('index')" @on-click-more="more('inbox')">
                <a class="spans" slot="back-icon">
                    <img class="imgsbank" src="../../assets/img/my-icon/fanhui.png" />
                </a>
                我的
                <a class="spansright inbox-num" slot="more-icon">
